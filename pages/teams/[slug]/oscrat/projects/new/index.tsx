...
import { OscratProductType, OscratProductCategory } from '@prisma/client';
import type { OscratProductCreate } from '@/types/oscrat/product';
...
export default function AddProject() {
  ...
  return (
    <div className="mt-10 flex w-full justify-center">
      <div className="w-full rounded-lg border bg-white p-6 shadow-lg dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 md:w-1/2 lg:w-1/3">
...
AddProject.getLayout = function getLayout(page: React.ReactNode) {
  return (
    <AccountLayout>
