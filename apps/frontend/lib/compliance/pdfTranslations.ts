...
export interface PDFTranslations {
  ...
  area: string;
  evaluationStatusChart: string;
  conformityBreakdownChart: string;
...
export function buildPDFTranslations(t: TFunction): PDFTranslations {
  return {
    ...
    evaluationStatusChart: t('oscrat.ui.dashboard.evaluation-status'),
    conformityBreakdownChart: t('oscrat.ui.dashboard.conformity-breakdown'),
    taskDistribution: t('oscrat.ui.dashboard.task-distribution'),
    autoGenerated: t('oscrat.ui.dashboard.auto-generated'),
    manual: t('oscrat.ui.dashboard.manual'),
    todo: t('oscrat.ui.dashboard.todo'),
    inProgress: t('oscrat.ui.dashboard.in-progress'),
    done: t('oscrat.ui.dashboard.done'),
  };
}
