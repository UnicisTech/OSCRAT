...
export const formStyles = {
  input: {
    ...
    disabled:
      'mt-1 w-full rounded-md border border-gray-300 bg-gray-100 px-3 py-2 text-gray-700 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300',
  },
  textarea: {
    base: 'mt-1 w-full rounded-md border px-3 py-2 dark:bg-gray-800 dark:text-gray-200',
    normal: 'border-gray-300 dark:border-gray-600',
...
export const getTextareaClassName = (hasError: boolean): string => {
  ...
  classes.push(
    hasError ? formStyles.textarea.error : formStyles.textarea.normal
  );
  return classes.join(' ');
};
