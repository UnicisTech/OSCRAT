import AddFileModal from '@/components/versions/versionDetails/tabs/allTabs/files/modal';
import FileTable from '@/components/versions/versionDetails/tabs/allTabs/files/fileTable';
